<template>
  <div class="vdp-datepicker" :class="[wrapperClass, isRtl ? 'rtl' : '']">
    ...
    <Popper>
      <div class="ui-input-group" slot="reference">
        <span v-if="calendarButton" class="ui-icon ui-icon-calendar"  @click="showCalendar"></span>
        <input
          ...
          :required="required"
        />
        <span v-if="clearButton && selectedDate" class="ui-icon ui-icon-cross"  @click="clearDate()"></span>
      </div>
...
import DateLanguages from '../utilities/date/languages'
